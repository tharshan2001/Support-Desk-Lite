...
const TicketCard = ({ ticket }) => {
  ...
  return (
    ...
    >
      <div className="p-2">
        {/* Top Row: Reporter */}
        <div className="flex items-center gap-2 mb-1 text-[9px] text-gray-500">
          ...
          <span className="flex items-center gap-0.5 text-[8px]">
            ...
            <time dateTime={ticket.createdAt}>{getTimeAgo(ticket.createdAt)}</time>
          </span>
        </div>

        {/* Title + Badges */}
        <div className="flex items-center justify-between mb-1">
          <h4 className="text-[6px] text-gray-900 truncate group-hover:text-green-700">
            {ticket.title}
          </h4>
        ...
        {/* Description */}
        <p className="text-[8px] text-gray-600 line-clamp-2 leading-snug">
          {ticket.description}
        </p>
      </div>
    </Link>
