...
const CreateTicketPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post("/tickets", { ...form, tags });
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      ...
      <div className="bg-white shadow-md rounded-lg p-8 animate-fadeIn">
        <h2 className="text-2xl font-semibold mb-1">Create New Ticket</h2>
              ...
              {tags.map((t) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    onClick={() => removeTag(t)}
                    className="flex items-center justify-center text-green-800 hover:text-green-900"
                  >
                    <X size={12} />
                  </button>
                </span>
